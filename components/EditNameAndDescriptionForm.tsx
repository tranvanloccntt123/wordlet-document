...
const EditNameAndDescriptionForm: React.FC<{
  initName: string;
  initDescription: string;
  title: string;
  onSubmit: (name: string, description: string) => any;
}> = ({ initName, initDescription, title, onSubmit }) => {
...
export default EditNameAndDescriptionForm;
